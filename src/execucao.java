...
public class execucao {
	public static void main(String[] args) {
		...
		Endereco endereco2 = new Endereco(66, "Santa L�cia");
		...
		Curso curso1 = new Curso(instrutor1, "Dom�stica", 40);
		Curso curso2 = new Curso(instrutor2, "Servi�os gerais", 80);
		...
		do {
			...
			case 1:
				...
				while(controladorAluno.verificarCpfExiste(cpf)) {
					System.out.println("Cpf j� existente! Porfavor digite outro.");
					cpf = ler.nextLine();
				}
				...
				System.out.println("1: Dom�stica");
				...
				System.out.println("6: Informa��es de cursos");
				opcao_cursos = ler.nextInt();
				if(opcao_cursos == 1) {
					System.out.println("Curso escolhido: Dom�stica");
				}
				if(opcao_cursos == 2) {
					System.out.println("Curso escolhido: Servi�os gerais");
				}
				if(opcao_cursos == 3) {
				...
				break;
			case 2:
				System.out.println("Atualiza��o de cadastro");
